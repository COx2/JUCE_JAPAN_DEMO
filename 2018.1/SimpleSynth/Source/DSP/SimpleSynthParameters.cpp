...
void OscillatorParameters::storeParameters(XmlElement& xml)
{
...
void OscillatorParameters::restoreParameters(XmlElement& xml)
{
...
void AmpEnvelopePatameters::storeParameters(XmlElement & xml)
{
...
void AmpEnvelopePatameters::restoreParameters(XmlElement & xml)
{
...
void LfoParameters::storeParameters(XmlElement & xml)
{
...
void LfoParameters::restoreParameters(XmlElement & xml)
{
...
void FilterPatameters::storeParameters(XmlElement & xml)
{
...
void FilterPatameters::restoreParameters(XmlElement & xml)
{
...
void ReverbPatameters::storeParameters(XmlElement & xml)
{
...
void ReverbPatameters::restoreParameters(XmlElement & xml)
{
